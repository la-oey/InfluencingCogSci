...
while(T){
  null.output = replicate(15, NullShuffleBundle(topic.df.50,centrality_subset,50, author.mat, year.mat))
  write.csv(null.output, file = paste0('H0_50/NullShuffleBundle50.', sample(1:1000000000, 1),'.csv'))

  null.output = replicate(15, NullShuffleBundle(topic.df.100,centrality_subset,100, author.mat, year.mat))
